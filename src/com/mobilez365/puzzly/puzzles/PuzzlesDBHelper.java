...
public class PuzzlesDBHelper extends SQLiteOpenHelper {
    ...
    public static final String[] FIND_ALL_COLUMN = {GAME_TYPE, GAME_WORD_ENG, GAME_WORD_RUS, GAME_PARTS_FINAL_POSITION_X, GAME_PARTS_FINAL_POSITION_Y,
